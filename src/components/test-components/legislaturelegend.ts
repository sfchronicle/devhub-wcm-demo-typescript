...
// const LegislatureLegend = React,FC = () => {
//   const text: string[] = ['Not up for election', 'Called', 'Leaning'];
//   const colorBase = (party: string) => '';
//   const color = (party: string) => '';
//   const colorVoting = (party: string) => '';
