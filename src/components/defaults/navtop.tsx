...
const NavTop = ({ meta, url_add = '' }) => {
  ...
  */
  ...
  if (['Texcom','Midcom','CT'].indexOf(meta.PROJECT.MARKET_KEY) === -1) {
    startingHTML = getNav2(meta, url_add, null, navLink, sectionArray)
  }
  ...
  useEffect(() => {
    ...
    setNavHTML(getNav2(meta, url_add, null, navLink, sectionArray))
